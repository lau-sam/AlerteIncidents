...
public class TypeMediaDB {
    ...
    public TypeMediaDB setInt(String key, int value)
    {
        this.integers.put(key, value);
        return this;
    }

    public TypeMediaDB setString(String key, String value)
    {
        this.strings.put(key, value);
        return this;
    }

    public TypeMediaDB set(String key, Object value)
    {
