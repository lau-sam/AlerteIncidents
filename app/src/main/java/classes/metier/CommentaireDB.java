...
public class CommentaireDB {
    ...
    public CommentaireDB setInt(String key, int value)
    {
        this.integers.put(key, value);
        return this;
    }

    public CommentaireDB setString(String key, String value)
    {
        this.strings.put(key, value);
        return this;
    }

    public CommentaireDB set(String key, Object value)
    {
